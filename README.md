...
- `ControlUIScale` — Launcher and control UI size, from `100` to `200`.
...
- `RenderPipeline` — Rendering mode: `0` uses immediate rendering; `1` enables the three-stage pipeline and adds visual delay (consume extra memory).
